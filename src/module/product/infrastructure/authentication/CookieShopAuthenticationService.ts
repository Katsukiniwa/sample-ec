...
export class CookieShopAuthenticationService implements ShopAuthenticationService {
  ...
  public async shopFrom(request: TypedRequestCookie<{sessionId: string; rememberToken: string}>): Promise<Shop> {
